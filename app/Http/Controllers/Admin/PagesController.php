...
class PagesController extends Controller
{
    ...
    public function pageimages()
    {
        ...
        $uploadedFileName = $this->uploadImage($file, CK_IMAGE_UPLOAD_PATH);
        $imageUrl = htmlspecialchars(CK_IMAGE_DISPLAY_PATH . $uploadedFileName, ENT_QUOTES, 'UTF-8');
        echo "<span style='font-size:12px;color:#f00;font-weight:bold;'>
            Copy below URL and paste it in Image Info tab then click OK:
          </span>
          <span style='float:left;font-size:13px;margin:2px 0 0;width:100%;'>
            {$imageUrl}
          </span>";
