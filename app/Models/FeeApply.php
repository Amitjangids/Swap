...
class FeeApply extends Model
{
    use Sortable;
    protected $table = "user_fee_apply";
    ...
    protected $fillable = [
        'user_id', 'receiver_id', 'userId','amount', 'trans_type', 'payment_mode', 'refrence_id', 'status', 'created_at', 'updated_at','slabId','min_amount','max_amount','fee_amount','fee_type','transaction_type','slug'
    ];
}
