...
class OnafriqReportExport implements FromCollection, WithHeadings, WithEvents
{
    protected $records;
    ...
    public function collection()
    {
        ...
        foreach ($this->records as $record) {
            ...
            switch ($record->recipientCountry) {
                case 'BJ':
                    $recipientCountry = 'Benin';
                    break;
                case 'BF':
                    $recipientCountry = 'Burkina Faso';
                    break;
                case 'GW':
                    $recipientCountry = 'Guinea Bissau';
                    break;
                case 'NE':
                    $recipientCountry = 'Niger';
                    break;
                case 'SN':
                    $recipientCountry = 'Senegal';
                    break;
                case 'ML':
                    $recipientCountry = 'Mali';
                    break;
                case 'TG':
            ...
            $result[] = array(
                'id' => $i,
                'Sender Name' => "{$record->senderName} {$record->senderSurname}",
                'Sender Phone' => $record->senderMsisdn,
                'Receiver Name' => "{$record->recipientName} {$record->recipientSurname}",
                "Receiver Phone" => $record->recipientMsisdn,
