...
class VisaReportExport implements FromCollection,WithHeadings,WithEvents
{
    protected $records;
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class    => function(AfterSheet $event) use($styleArray,$styleArray1) {
                ...
                $event->sheet->getStyle('A'.$heighest_row.':I'.$heighest_row)->ApplyFromArray($styleArray1);
