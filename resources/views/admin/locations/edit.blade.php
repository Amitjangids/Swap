    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{URL::to('admin/locations')}}"><i class="fa fa-user-secret"></i> <span>Manage
                            Location</span></a>
                </li>
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {{Form::text('name', null, ['class' => 'form-control required', 'placeholder' => 'Enter Name', 'autocomplete' => 'off'])}}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Address<span class="require"></span></label>
                            <div class="col-sm-10">
                                {{Form::text('address', null, ['class' => 'form-control required', 'placeholder' => 'Enter address', 'autocomplete' => 'off'])}}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Telephone<span class="require"></span></label>
                            <div class="col-sm-10">
                                {{ Form::text('telephone', null, ['class' => 'form-control', 'placeholder' => 'Enter Phone', 'autocomplete' => 'off']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {{ Form::text('latitude', null, ['class' => 'form-control', 'placeholder' => 'Enter latitude', 'autocomplete' => 'off']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {{ Form::text('longitude', null, ['class' => 'form-control', 'placeholder' => 'Enter longitude', 'autocomplete' => 'off']) }}

                            </div>
                        </div>
                        <div class="box-footer">
                            {{Form::submit('Submit', ['class' => 'btn btn-info'])}}
                            <a href="{{ URL::to('admin/locations')}}" title="Cancel"
