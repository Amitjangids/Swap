                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{Form::text('phone', null, ['id'=>'phone','class'=>'form-control required digits', 'placeholder'=>'Phone Number', 'autocomplete' => 'off','minlength' => '8',
                            'maxlength' => '15'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <!--<input id="phone" name="phone" type="tel">-->
                            {{ Form::select('company_code', $company_code, null, ['class' => 'form-control required','placeholder' => (Session::get('admin_role') != env('AGGREGATOR_ID')) ? 'Select Company' : null]) }}
                        </div>
                    </div>  
