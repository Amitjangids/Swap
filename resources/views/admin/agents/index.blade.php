    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                {{ Form::close()}}
                @if(in_array('add-agents',$permissions))
                <div class="add_new_record"><a href="{{URL::to('admin/agents/add-agents')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Agent User</a></div>
                @endif
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.agents.index')
            </div>
        </div>
    </section>
