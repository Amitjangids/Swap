...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/referral-setting')}}"><i class="fa fa-exchange"></i> <span>Manage Referral Setting Fees</span></a></li>
            ...
            <div class="form-horizontal">
                ...
                <?php global $typefor; ?>
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radd"> 
                                {{ Form::radio('fee_type', '0', $recordInfo->fee_type == 0, ['0' => 'percentage']) }} 
                                <span>Percentage</span> 
                            </div>
                            <div class="radd"> 
                                {{ Form::radio('fee_type', '1', $recordInfo->fee_type == 1, ['1' => 'flat_rate']) }} 
                                <span>Flat Rate</span> 
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            {{ Form::text('fee_value', $recordInfo->fee_value, ['class'=>'form-control required', 'placeholder'=>'Fee Amount', 'autocomplete' => 'off','onkeypress'=>"return validateFloatKeyPress(this,event);", 'onpaste' => 'return false;', 'oncopy' => 'return false;']) }}
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/referral-setting')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
