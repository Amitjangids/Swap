            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('business_name', null, ['class'=>'form-control required', 'placeholder'=>'Business Name', 'autocomplete' => 'off', 'maxlength' => 25])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('name', null, ['class'=>'form-control required', 'placeholder'=>'Business Owner Name', 'autocomplete' => 'off', 'maxlength' => 25])}}
                        </div>
                    </div>
                   ...
                   <!-- <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('registration_number', null, ['class'=>'form-control required', 'placeholder'=>'Business registration number', 'autocomplete' => 'off', 'minlength' => 8, 'maxlength' => 16])}}
                        </div>
                    </div>   -->
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">Upload front picture of your national identity <span class="require"></span></label>
                        <div class="col-sm-10">
                            {{Form::file('identity_front_image', ['class'=>'form-control', 'accept'=>IMAGE_EXT])}}
                            ...
                            <div class="help-text"><a href="{{ URL::to('admin/merchants/deleteidentity/'.$recordInfo->slug)}}" title="Delete Image" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">Delete Image</a></div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::file('identity_back_image', ['class'=>'form-control', 'accept'=>IMAGE_EXT])}}
                            <span class="help-text"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                            ...
                            <div class="help-text"><a href="{{ URL::to('admin/merchants/deleteidentity1/'.$recordInfo->slug)}}" title="Delete Image" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">Delete Image</a></div>
                            @endif
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        <label class="col-sm-2 control-label">Business Image Upload <span class="require"></span></label>
                        <div class="col-sm-10">
