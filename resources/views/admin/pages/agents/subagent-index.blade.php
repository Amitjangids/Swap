...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Manage Sub-Agent Users</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li class="active"> Manage Sub-Agent Users</li>
        </ol>
    </section>
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/agents')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
                <div class="add_new_record"><a href="{{URL::to('admin/sub-agents/add/'.$data->slug)}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Sub-Agent User</a></div>
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.agents.sub-agent-index')
            </div>
        </div>
    </section>
