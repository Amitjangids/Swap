...
<div class="login-logo">{{HTML::image(LOGO_PATH, SITE_TITLE,['style' => 'width: 200px; height: auto;'])}}</div>
<div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>
    @include('elements.admin.errorSuccessMessage')
    
    {{ Form::open(array('method' => 'POST', 'url' => 'admin/login', 'id' => 'adminlogin', 'class' => 'form form-signin')) }}
