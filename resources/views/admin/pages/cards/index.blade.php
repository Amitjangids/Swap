        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    <!--<span class="hints">Search by Company Name</span>-->
                    <span class="hint">
                        <label>Search by Company Name</label>
                        {{Form::text('keyword', null, ['class'=>'form-control', 'placeholder'=>'Search by keyword', 'autocomplete' => 'off'])}}</span>
                    <span class="hint">   
                ...
                {{ Form::close()}}
                <div class="add_new_record"><a href="{{URL::to('admin/cards/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Card</a></div>
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.cards.index')
            </div>
        </div>
    </section>
</div>
