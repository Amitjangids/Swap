...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Card Offer</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="{{URL::to('admin/cards')}}"><i class="fa fa-gift"></i> <span>Manage Cards</span></a></li>
            <li><a href="{{URL::to('admin/cards/carddetail/'.$cslug)}}"><i class="fa fa-gift"></i> <span>Manage Card Details</span></a></li>
            <li><a href="{{URL::to('admin/cards/carddetail/'.$cslug.'/'.$cid)}}"><i class="fa fa-gift"></i> <span>Manage Card Offers</span></a></li>
            <li class="active"> Add Card Offer</li>
        </ol>
    </section>
        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Value For User <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::text('card_value', null, ['class'=>'form-control required digits', 'placeholder'=>'Value', 'autocomplete' => 'off','min' => 1])}}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Value For Agent <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::text('agent_card_value', null, ['class'=>'form-control required', 'placeholder'=>'Value For Agent', 'autocomplete' => 'off','min' => 1])}}
                        </div>
                    </div>
                    <div class="form-group">
