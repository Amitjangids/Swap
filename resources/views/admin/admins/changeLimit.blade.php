            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('minDeposit', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Deposit  Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('maxDeposit', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum  Deposit Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('minAirtel', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Airtel Deposit Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('maxAirtel', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Airtel Deposit Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('minWithdraw', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum  Withdraw Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('maxWithdraw', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum  Withdraw Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('minSendMoney', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum  SendMoney', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('maxSendMoney', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum  SendMoney', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('gimacMin', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Gimac Transfer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('gimacMax', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Gimac Transfer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('bdaMin', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Bda Transfer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('bdaMax', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Bda Transfer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('onafriqa_min', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Onafriq Transfer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('onafriqa_max', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Onafriq Transfer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('moneyReceivingMin', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Receiving Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('moneyReceivingMax', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Receiving Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('unverifiedKycMin', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Unverified Kyc Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('unverifiedKycMax', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Unverified Kyc Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('bulkMin', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Minimum Bulk Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('bulkMax', null, ['min'=>'1','class'=>'form-control', 'placeholder'=>'Maximum Bulk Amount', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
