        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                ...
                <?php global $typefor; ?>
                    ...
                    @if($recordInfo->transaction_type == 'Deposit')
                        <?php $selectedType = 'Sell Balance'; ?>
                    @elseif($recordInfo->transaction_type == 'Withdraw')
                        <?php $selectedType = 'Buy Balance'; ?>
                    @elseif($recordInfo->transaction_type == 'Send Money')
                        <?php $selectedType = 'Send Money'; ?>
                    @elseif($recordInfo->transaction_type == 'Refund')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            {{ Form::select('type', $typefor, $recordInfo->transaction_type, ['class' => 'form-control required', 'placeholder' => 'Select Fee Transaction Type', 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            {{ Form::select('amount_slab', $options, $recordInfo->min_amount . '-' . $recordInfo->max_amount, ['class' => 'form-control required', 'placeholder' => 'Select Amount Slab']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radd"> 
                                {{ Form::radio('feetype', '0', $recordInfo->fee_type == 0, ['0' => 'percentage']) }} 
                                <span>Percentage</span> 
                            </div>
                            <div class="radd"> 
                                {{ Form::radio('feetype', '1', $recordInfo->fee_type == 1, ['1' => 'flat_rate']) }} 
                                <span>Flat Rate</span> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            {{ Form::text('feecharge', $recordInfo->fee_amount, ['class'=>'form-control required', 'placeholder'=>'Fee Amount', 'autocomplete' => 'off','onkeypress'=>"return validateFloatKeyPress(this,event);", 'onpaste' => 'return false;', 'oncopy' => 'return false;']) }}
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        {{ Form::submit('Submit', ['class' => 'btn btn-info', 'onclick' => 'disable_submit()']) }}
