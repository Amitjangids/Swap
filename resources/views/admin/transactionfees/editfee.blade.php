...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit Transaction Fees For {{$userInfo->user_type}} <small>({{$userInfo->name}})</small></h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="{{URL::to('admin/transactionfees/transactionfee/'.$userInfo->slug)}}"><i class="fa fa-exchange"></i> <span>Manage Transaction Fees</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/transactionfees/transactionfee/'.$userInfo->slug)}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
