...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/users')}}"><i class="fa fa-users"></i> <span>Manage Fee Configuration</span></a></li>
        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                        ...
                        <?php global $typefor; ?>
                        <div class="col-sm-3">
                        {{Form::select('type',$typefor, null, ['class'=>'form-control required alphabat', 'placeholder'=>'Select Fee Transaction Type', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            ?>
                            {{ Form::select('amount_slab', $options, null, ['class' => 'form-control required', 'placeholder' => 'Select Amount Slab']) }}
                        </div>
                    </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radd"> {{ Form::radio('feetype', '0', true) }} <span class="fee">Percentage</span> </div>
                            <div class="radd"> {{ Form::radio('feetype', '1', false) }} <span class="fee">Flat Rate</span> </div>
                        </div>
                    </div> 
                    <div class="form-group">
    <label class="col-sm-2 control-label">Fee Amount<span class="require">*</span></label>
    <div class="col-sm-3">
        {{ Form::text('feecharge', null, ['class'=>'form-control required', 'placeholder'=>'Fee Amount', 'autocomplete' => 'off','onkeypress'=>"return validateFloatKeyPress(this,event);", 'onpaste' => 'return false;', 'oncopy' => 'return false;']) }}
    </div>
</div>
