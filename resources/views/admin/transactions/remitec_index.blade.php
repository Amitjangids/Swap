...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Manage Remitec Transactions</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li class="active"> Manage Remitec Transactions</li>
        </ol>
    </section>
<style>
        .row-button {
                ...
                <div class="form-group align_box dtpickr_inputs">
                   ...
                   <?php /* <span class="hint">
                    ...
                    <span class="hint">
                        ...
                        <?php global $Remitec; ?>                        
                        {{Form::select('type', $Remitec,null, ['class' => 'form-control','placeholder' => 'Select transaction for'])}}
                    </span>
...
<!--<span class="hint">{{Form::text('for', null, ['class'=>'form-control', 'placeholder'=>'Search by transaction for', 'autocomplete' => 'off'])}}</span>-->
                    ...
                    <div class="admin_asearch row-button">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/remitec-transactions')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            ...
            <div class="m_content" id="listID">
                @include('elements.admin.transactions.remitec_index')
            </div>
        </div>
    </section>
