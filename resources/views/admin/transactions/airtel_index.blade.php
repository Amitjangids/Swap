    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch row-button">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/airtel-transaction')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            ...
            <div class="m_content" id="listID">
                @include('elements.admin.transactions.airtel_index')
            </div>
        </div>
    </section>
