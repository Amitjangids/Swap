        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <span class="hint"><label>Search by sender name</label>{{Form::text('sender', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by sender name', 'autocomplete' =>
                        'off'])}}</span>
                    <span class="hint"><label>Search by sender phone</label>{{Form::text('sender_phone', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by sender phone', 'autocomplete' =>
                        'off'])}}</span>
                    <span class="hint"><label>Search by receiver name</label>{{Form::text('receiver', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by receiver name', 'autocomplete' =>
                        'off'])}}</span>

                    <span class="hint"><label>Search by receiver phone</label>{{Form::text('receiver_phone', null,
              ...
              {{Form::select('type', $typeList,null, ['class' => 'form-control','placeholder' => 'Select transaction type'])}}
                    ...
                    <div class="admin_asearch row-button">
                        <div class="ad_s ajshort">{{Form::button('Submit', ['class' => 'btn btn-info
                            admin_ajax_search'])}}</div>
                        <div class="ad_cancel"><a href="{{URL::to('admin/onafriq-transactions')}}"
            ...
            <div class="m_content" id="listID">
                @include('elements.admin.transactions.onafriq_index')
            </div>
        </div>
    </section>
