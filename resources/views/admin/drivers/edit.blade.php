...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/drivers')}}"><i class="fa fa-user-secret"></i> <span>Manage Driver</span></a>
            </li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('name', null, ['class'=>'form-control name required', 'placeholder'=>'Enter
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('email', null, ['class'=>'form-control email required', 'placeholder'=>'Enter
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/drivers')}}" title="Cancel"
