...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/merchants')}}"><i class="fa fa-users"></i> <span>Manage Merchant User</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('email', null, ['class'=>'form-control  email', 'placeholder'=>'Business Email', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{Form::text('phone', null, ['id'=>'phone','class'=>'form-control required digits', 'placeholder'=>'Phone Number', 'autocomplete' => 'off','minlength' => '9',
                            'maxlength' => '9'])}}
