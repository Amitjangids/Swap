            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('national_identity_number', null, ['class'=>'form-control required', 'placeholder'=>'National Identity Number', 'autocomplete' => 'off', 'minlength' => 8, 'maxlength' => 12])}}
                        </div>
                    </div>
                     
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Upload front picture of business owner’s national identity <span class="require"></span></label>
                        <div class="col-sm-10">
                            {{Form::file('identity_front_image', ['class'=>'form-control required', 'accept'=>IMAGE_EXT])}}
                            <span class="help-text"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">Upload bak picture of business owner’s national identity <span class="require"></span></label>
                        <div class="col-sm-10">
                            {{Form::file('identity_back_image', ['class'=>'form-control required', 'accept'=>IMAGE_EXT])}}
                            <span class="help-text"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                        </div>
                    </div>
