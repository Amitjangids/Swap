...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            @php
            $roles = AdminsController::getRoles(Session::get('adminid'),2);
            @endphp
            <?php if ($roles == 1) { ?>
            ...
            <?php } ?>
            @php
            $roles = AdminsController::getRoles(Session::get('adminid'),10);
            @endphp
            <?php if ($roles == 1) { ?>
            <div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-purple">
                    <div class="inner">
                        <h3>{{$dadhboardData['scratchcards_count']}}</h3>
                        <p>Scratch Cards</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-ticket"></i>
                    </div>
                    <a href="{{URL::to( 'admin/scratchcards')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <?php } ?> -->
            <!-- @php
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3>{{$dadhboardData['mobilecards_count']}}</h3>
                        <p>Mobile Recharge Cards</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-credit-card"></i>
                    </div>
                    <a href="{{URL::to( 'admin/cards')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <?php } ?>
            @php
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-olive">
                    <div class="inner">
                        <h3>{{$dadhboardData['internetcards_count']}}</h3>
                        <p>Internet Recharge Cards</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-credit-card"></i>
                    </div>
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-maroon">
                    <div class="inner">
                        <h3>{{$dadhboardData['onlinecards_count']}}</h3>
                        <p>Online Cards</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-credit-card"></i>
            ...
            <?php } ?>
            @php
            $roles = AdminsController::getRoles(Session::get('adminid'),15);
            @endphp
            <?php if ($roles == 1) { ?>
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-gray">
                    <div class="inner">
                        <h3>{{$dadhboardData['login_users_count']}}</h3>
                        <p>Logged In Users</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-users"></i>
                    </div>
                    <a href="{{URL::to( 'admin/users/loginusers')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
