            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/subadmins')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}


                @if(in_array('add-subadmins',$permissions))
                <div class="add_new_record"><a href="{{URL::to('admin/subadmins/add-subadmins')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Sub Admin</a></div>
                @endif
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.subadmins.index')
            </div>
        </div>
    </section>
</div>
