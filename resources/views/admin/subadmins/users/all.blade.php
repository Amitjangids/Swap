...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Manage Total Register Users</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li class="active"> Manage Total Register Users</li>
        </ol>
    </section>
        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <span class="hint">
                        <?php  $userType = array('User' => 'User','Agent' => 'Agent','Merchant' => 'Merchant');?>                       
                        {{Form::select('user_type', $userType,null, ['id'=>'user','class' => 'form-control ','placeholder' => 'Select user type'])}}
                    </span>
                    <span class="hint">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/users/all')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.users.all')
            </div>
        </div>
    </section>
