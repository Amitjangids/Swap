                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="help-text"><a href="{{ URL::to('admin/agents/deleteidentity1/'.$recordInfo->slug)}}" title="Delete Image" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">Delete Image</a></div>
                            @endif
                        </div>
                    </div> 
