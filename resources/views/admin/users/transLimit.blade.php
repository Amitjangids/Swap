            ...
            <!-- <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/users/transactions-limit')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            </div>             -->
            <div class="m_content" id="listID">
                @include('elements.admin.users.limitTrans')
            </div>
        </div>
    </section>
</div>
