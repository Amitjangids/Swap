                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{Form::text('phone', null, ['id'=>'phone','class'=>'form-control required digits', 'placeholder'=>'Phone Number', 'autocomplete' => 'off'])}}
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/users/all')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
