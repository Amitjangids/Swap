    ...
    <section class="content">
        <div class="box box-info">
           ...
           <!--  <div class="admin_search">
                ...
                {{ Form::close()}}
                <div class="add_new_record"><a href="{{URL::to('admin/users/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add User</a>
                <a href="{{URL::to('admin/users/importuser')}}" class="btn btn-default"><i class="fa fa-plus"></i> Import User Details</a></div>
            </div>    -->         
            <div class="m_content" id="listID">
                @include('elements.admin.users.gabon_visa_stamp')
            </div>
        </div>
    </section>
