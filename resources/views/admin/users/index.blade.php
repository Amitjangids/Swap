    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="import-page-header-top">
                @if(in_array('add-users',$permissions) )
                <div class="add_new_record"><a href="{{URL::to('admin/users/add-users')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add User</a></div>
                @endif
                @if(in_array('importuser',$permissions))
                <div class="import_user"><a href="{{URL::to('admin/users/importuser')}}" class="btn btn-default"><i class="fa fa-plus"></i> Import User Details</a></div>
                @endif
            </div>
