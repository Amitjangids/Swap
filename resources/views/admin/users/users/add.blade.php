                ...
                <div class="box-body">
                    ...
                    <div id="input-fields">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {{Form::file('profile_image', ['class'=>'form-control required', 'accept'=>IMAGE_EXT,'onchange'=>'ProfileImage(this)','id'=>'profileimage'])}}
                                <span class="help-text" id="Profile" color="red"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Upload picture of your national identity front<span class="require"></span></label>
                            <div class="col-sm-10">
                                {{Form::file('identity_front_image', ['class'=>'form-control required', 'accept'=>IMAGE_EXT,'onchange'=>'frontImage(this)','id'=>'frontimage'])}}
                                <span class="help-text" id="frontimg" color="red"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Upload picture of your national identity back<span class="require"></span></label>
                            <div class="col-sm-10">
                                {{Form::file('identity_back_image', ['class'=>'form-control required', 'accept'=>IMAGE_EXT,'onchange'=>'backImage(this)','id'=>'backimage'])}}
                                <span class="help-text" id="backimg" color="red"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                            </div>
                        </div>
                    </div>
