            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/banners')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
                @php
                ...
                @if(in_array('add-banners',$permissions))
                <div class="add_new_record"><a href="{{URL::to('admin/banners/add-banners')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Banner</a></div>
                @endif
            </div>            
