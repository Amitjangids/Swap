        ...
        <section id="no-more-tables" class="lstng-section">
            ...
            <script>
                $('.export_excel').on('click', function () {
                    ...
                    var url = '{{ route("exportexcelonafriq") }}?sender=' + sender + '&sender_phone=' + sender_phone + '&receiver=' + receiver + '&receiver_phone=' + receiver_phone + '&refrence=' + refrence + '&to=' + requestD;
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ddpagingshorting">
                        <tr>
                            ...
                            <th class="sorting_paging">@sortablelink('receiverPhoneNumber', 'Receiver Phone')</th>
                            ...
                            <th class="sorting_paging">@sortablelink('type', 'Recipient Country')</th>
                        ...
                        @foreach ($allrecords as $allrecord) 
                                        <tr>
                                            <td data-title="Sender Name">
                                                {{ isset($allrecord->senderName) ? ucfirst($allrecord->senderName . ' ' . $allrecord->senderSurname) : 'N/A' }}
                                            </td>
                                            <td data-title="Sender Phone">
                                                {{ isset($allrecord->senderMsisdn) ? $allrecord->senderMsisdn : 'N/A' }}
                                            </td>
                                            <td data-title="Receiver Name">
                                                {{ isset($allrecord->recipientName) ? ucfirst($allrecord->recipientName . ' ' . $allrecord->recipientSurname) : 'N/A' }}
                                            </td>
                                            <td data-title="Receiver Phone">
                                                @if (isset($allrecord->recipientMsisdn))
                                                {{ $allrecord->recipientMsisdn }}@else{{ 'N/A' }}
                                                @endif
                                            </td>
                                            ...
                                            <td data-title="Transaction ID">{{ $allrecord->transactionId ?? 0 }}</td>
                                            <td data-title="Type">
                                                @php 
