            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging">@sortablelink('department', 'Department')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ optional($departments->firstWhere('id', $allrecord->role_id))->role_name }}</td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        ...
                                        @if($allrecord->status == '1')
                                        <a href="{{ URL::to( 'admin/subadmins/deactivate/'.$allrecord->slug)}}" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        @else
                                        <a href="{{ URL::to( 'admin/subadmins/activate/'.$allrecord->slug)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        @endif
                                    </li>
                                    @php
                                    ...
                                    @if(in_array('edit-subadmins',$permissions))
                                    <li><a href="{{ URL::to( 'admin/subadmins/edit-subadmins/'.$allrecord->slug)}}" title="Edit" class=""><i class="fa fa-pencil"></i>Edit Sub Admin</a></li>
                                    @endif
                                    @if(in_array('delete-subadmins',$permissions))
                                    <li><a href="{{ URL::to( 'admin/subadmins/delete-subadmins/'.$allrecord->slug)}}" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li>
                                    @endif
                                    
                                    <li><a href="#info{!! $allrecord->id !!}" title="View Sub Admin Detail" class="" rel='facebox'><i class="fa fa-eye"></i>View Sub Admin Detail</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
