    ...
    <section id="no-more-tables" class="lstng-section">
        ...
        <div class="tbl-resp-listing">
                ...
                <tbody>
                    ...
                    @endforeach
                        ...
                        <td data-title="Picture Selfie Image">  
                            ...
                            <a href="{{ HTTP_PATH }}/{{ IDENTITY_FULL_DISPLAY_PATH }}{{ $userInfo->selfie_image }}" title="View KYC Document" data-fancybox-group="gallery1" class="fancybox" target="_blank">
                                {{HTML::image(IDENTITY_FULL_DISPLAY_PATH.$userInfo->selfie_image, SITE_TITLE,['style'=>'max-width:50px; max-height:50px;'])}}
                            </a>
                        ...
                        <td data-title="Picture Front Image">  
                            ...
                            <a href="{{ HTTP_PATH }}/{{ IDENTITY_FULL_DISPLAY_PATH }}{{$userInfo->identity_front_image}}" title="View KYC Document" data-fancybox-group="gallery1" class="fancybox" target="_blank">
                                {{HTML::image(IDENTITY_FULL_DISPLAY_PATH.$userInfo->identity_front_image, SITE_TITLE,['style' => 'max-width:50px; max-height:50px;'])}}
                            </a>
                            @else
                            No Image
                            @endif
                        ...
                        <td data-title="Picture Selfie Image">  
                            ...
                            <a href="{{ HTTP_PATH }}/{{ IDENTITY_FULL_DISPLAY_PATH }}{{$userInfo->identity_back_image}}" title="View KYC Document" data-fancybox-group="gallery1" class="fancybox" target="_blank">
                                {{HTML::image(IDENTITY_FULL_DISPLAY_PATH.$userInfo->identity_back_image, SITE_TITLE,['style' => 'max-width:50px; max-height:50px;'])}}
                            </a>
                            @endif
            ...
            <div class="search_frm"> 
                ...
                <a href="{{ URL::to('admin/merchants/approvekyc/' . $userInfo->slug) }}" title="Approve" class="btn btn-info">Approve Kyc</a>
                <?php } ?>
