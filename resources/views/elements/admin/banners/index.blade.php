                        ...
                        <td data-title="Action">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    @if(in_array('edit-banners',$permissions))
                                    <li><a href="{{ URL::to( 'admin/banners/edit-banners/'.$allrecord->slug)}}" title="Edit" class=""><i class="fa fa-pencil"></i>Edit Banner</a></li>
                                    @endif
                                    @if(in_array('delete-banners',$permissions))
                                    <li><a href="{{ URL::to( 'admin/banners/delete-banners/'.$allrecord->slug)}}" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li>
                                    @endif
