    ...
    <section id="no-more-tables" class="lstng-section">
        ...
        <div class="tbl-resp-listing">
            ...
            <div class="search_frm"> 
                ...
                <a href="{{ URL::to( 'admin/agents/approvekyc/'.$userInfo->slug)}}" title="Approve KYC" class="btn btn-info">Approve KYC</a>
                <a href="{{ URL::to( 'admin/agents/declinekyc/'.$userInfo->slug)}}" title="Decline KYC" class="btn btn-info">Decline KYC</a>
                @elseif($userInfo->is_kyc_done == 2)
                ...
                <a href="{{ URL::to('admin/agents/approvekyc/' . $userInfo->slug) }}" title="Approve" class="btn btn-info">Approve Kyc</a>
                <?php } ?>
