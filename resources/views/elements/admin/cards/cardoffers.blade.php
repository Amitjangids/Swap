            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging">@sortablelink('agent_card_value', 'Card Value For Agent')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Card Value For Agent">{{CURR}} {{$allrecord->agent_card_value}}</td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        ...
                                        @else
                                        <a href="{{ URL::to( 'admin/cards/activatecarddetail/'.$allrecord->id)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate User</a>
                                        @endif
                                    </li>
                                    ...
                                    <li><a href="{{ URL::to( 'admin/cards/offerlist/'.$allrecord->slug)}}" title="Special Offer List" class=""><i class="fa fa-list"></i>Special Offer List</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                ...
                <div class="admin_pop"><span>Card Value: </span>  <label>{!! $allrecord->card_value !!}</label></div>
                <div class="admin_pop"><span>Card Value For Agent: </span>  <label>{!! $allrecord->agent_card_value !!}</label></div>
