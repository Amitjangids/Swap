            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging">@sortablelink('address', 'Address')</th>
                        <th class="sorting_paging">@sortablelink('telephone', 'Telephone')</th>
                        <th class="sorting_paging">@sortablelink('Latitude', 'Latitude')</th>
                        <th class="sorting_paging">@sortablelink('Longitude', 'Longitude')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Address">{{$allrecord->address ?? ""}}</td>
                        <td data-title="Telephone">{{$allrecord->telephone ?? 'N/A'}}</td>
                        <td data-title="Latitude">{{$allrecord->latitude ?? 'N/A'}}</td>
                        <td data-title="Longitude">{{$allrecord->longitude ?? 'N/A'}}</td>
                        ...
                        <td data-title="Action">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    @if(in_array('edit-location',$permissions))
                                    <li><a href="{{ URL::to( 'admin/locations/edit-location/'.$allrecord->id)}}"
                                            title="Edit" class=""><i class="fa fa-pencil"></i>Edit Location</a></li>
                                    @endif

                                    @if(in_array('delete-location',$permissions))
                                    <li><a href="{{ URL::to( 'admin/locations/delete-location/'.$allrecord->id)}}"
                                            title="Delete" class=""
