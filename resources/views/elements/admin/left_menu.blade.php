        ...
        <ul class="sidebar-menu">
          @if(in_array('dashboard',$permissions))
           ...
           @if(in_array('change-username', $permissions) ||
            ...
            {{-- @if(in_array('card-request-list', $permissions)) --}}
            <li class="treeview @if(isset($actcardrequestlist) || isset($actcardassignlist)){{'active'}}@endif">
                <a href="javascript:void(0)">
                    <i class="fa fa-money"></i> <span>Manage Card Request List </span> <i class="fa fa-angle-right pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="@if(isset($actcardrequestlist) || isset($actcardassignlist)){{'active'}}@endif"><a href="{{HTTP_PATH}}/admin/card-request/list"><i class="fa fa-circle-o"></i>
          ...
          @endif
            ...
            @if(in_array('subadmins',$permissions))
                ...
                @if(in_array('location-list',$permissions))
                <li class="treeview @if(isset($actlocations)){{'active'}}@endif">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="@if(isset($actlocations)){{'active'}}@endif"><a href="{{URL::to('admin/locations')}}"><i class="fa fa-circle-o"></i>Ecobank Location List</a></li>
                            ...
                            <a href="javascript:void(0)">
                             ...
                             <ul class="treeview-menu">
                                @if( in_array('amountSlab',$permissions))                           
                                    <li class="@if(isset($acttranfees1)) {{'active'}} @endif">
                                        <a href="{{HTTP_PATH}}/admin/transactionfees/amountSlab">
            ...
            @if(in_array('referral-listing',$permissions))
            <li class="treeview @if(isset($actreferral) || isset($actreferralfees)){{'active'}}@endif">
                <a href="javascript:void(0)">
                    <i class="fa fa-money"></i> <span>Manage Referral</span> <i class="fa fa-angle-right pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="@if(isset($actreferral)){{'active'}}@endif"><a href="{{URL::to('admin/referral-listing')}}"><i class="fa fa-circle-o"></i>Referral Earning List</a></li>
                    @if(in_array('referral-setting', $permissions) )
                    <li class="@if(isset($actreferralfees)){{'active'}}@endif"><a href="{{URL::to('admin/referral-setting')}}"><i class="fa fa-circle-o"></i>Referral Setting</a></li>
                  @endif
                </ul>
            </li>
            @endif
            ...
            @if(in_array('airtel-transactions',$permissions))
            <li class="treeview @if(isset($act_airtel_transactions)){{'active'}}@endif">
                <a href="javascript:void(0)">
                    <i class="fa fa-money"></i> <span>Manage Airtel Money </span> <i class="fa fa-angle-right pull-right"></i>
                </a>
                <ul class="treeview-menu">
                
                    <li class="@if(isset($act_airtel_transactions)){{'active'}}@endif"><a href="{{HTTP_PATH}}/admin/airtel-transaction"><i class="fa fa-circle-o"></i>Airtel Money Transactions List</a></li>
                    
                </ul>
            </li>@endif

            @if(in_array('airtel-transactions',$permissions))
            <li class="treeview @if(isset($act_visa_transactions)){{'active'}}@endif">
                <a href="javascript:void(0)">
                    <i class="fa fa-money"></i> <span>Manage VISA Transactions </span> <i class="fa fa-angle-right pull-right"></i>
                </a>
                <ul class="treeview-menu">
                
                    <li class="@if(isset($act_visa_transactions)){{'active'}}@endif"><a href="{{HTTP_PATH}}/admin/visa-transaction"><i class="fa fa-circle-o"></i>VISA Transactions List</a></li>
                    
                </ul>
            </li>@endif

            @if(in_array('external-transactions',$permissions))
            <li class="treeview @if(isset($act_external_transactions)){{'active'}}@endif">
                <a href="javascript:void(0)">
                    <i class="fa fa-money"></i> <span>Manage External Transactions </span> <i class="fa fa-angle-right pull-right"></i>
                </a>
                <ul class="treeview-menu">
                
                    <li class="@if(isset($act_external_transactions)){{'active'}}@endif"><a href="{{HTTP_PATH}}/admin/external-transaction"><i class="fa fa-circle-o"></i>External Transactions List</a></li>
                    
                </ul>
            </li>@endif

            <!-- <li class="@if (isset($act_airtel_transactions)) {{ 'active' }} @endif">
            <li class="treeview @if (isset($act_airtel_transactions) || isset($act_airtel_transactions)) {{ 'active' }} @endif"></li> -->
