                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        @if($allrecord->status == '1')
                                        <a href="{{ URL::to( 'admin/transactionfees/deactivatefee/'.$allrecord->id)}}" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        @else
                                        <a href="{{ URL::to( 'admin/transactionfees/activatefee/'.$allrecord->id)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        @endif
                                    </li>
                                    <li><a href="{{ URL::to( 'admin/transactionfees/editfee/'.$userInfo->slug.'/'.$allrecord->slug)}}" title="Edit Transaction Fee" class=""><i class="fa fa-pencil"></i>Edit Transaction Fee</a></li>
                                    <li><a href="{{ URL::to( 'admin/transactionfees/deletefee/'.$userInfo->slug.'/'.$allrecord->id)}}" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li>
