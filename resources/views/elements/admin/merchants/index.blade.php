                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        ...
                                        @if($allrecord->is_verify == '1')
                                        <a href="{{ URL::to( 'admin/merchants/deactivate/'.$allrecord->slug)}}" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        @else
                                        <a href="{{ URL::to( 'admin/merchants/activate/'.$allrecord->slug)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        @endif
                                    </li>
                                    @php
                                    ...
                                    <li><a href="{{ URL::to( 'admin/merchants/edit-merchants/'.$allrecord->slug)}}" title="Edit" class=""><i class="fa fa-pencil"></i>Edit Merchant</a></li>
                                    @endif
                                    @if(in_array('payclient',$permissions))
                                    <li><a href="{{ URL::to( 'admin/merchants/payclient/'.$allrecord->slug)}}" title="Pay Merchant" class=""><i class="fa fa-money"></i>Pay Merchant</a></li>
                                    ...
                                    @endif
                                    <li><a href="#info{!! $allrecord->id !!}" title="View Merchant Detail" class="" rel='facebox'><i class="fa fa-eye"></i>View Merchant Detail</a></li>
