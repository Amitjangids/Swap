            ...
            <div class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Maximum amount for single transaction <span class="require"></span></label>
                        <div class="col-sm-9">
                            {{Form::text('amount_limit', null, ['min'=>'0','class'=>'form-control', 'placeholder'=>'Limit', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
