...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit Scratchcard</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="{{URL::to('admin/scratchcards')}}"><i class="fa fa-ticket"></i> <span>Manage Scratchcards</span></a></li>
            <li class="active"> Edit Scratchcard</li>
        </ol>
    </section>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/scratchcards')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
