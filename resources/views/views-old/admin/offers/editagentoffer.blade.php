...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit Agent Offer For ({{$userInfo->name}})</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="{{URL::to('admin/agents')}}"><i class="fa fa-user-secret"></i> <span>Manage Agents</span></a></li>
            <li><a href="{{URL::to('admin/offers/agentoffers/'.$userInfo->slug)}}"><i class="fa fa-gift"></i> <span>Manage Agent Offers</span></a></li>
            <li class="active"> Edit Agent Offer</li>
        </ol>
    </section>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('offer', null, ['class'=>'form-control required dollarsscents', 'placeholder'=>'User Fee' ,'autocomplete' => 'off','min'=>0,'max'=>100])}}
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/offers')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
