<table width="710" align="center" style="table-layout:fixed; font-family:Arial, Helvetica, sans-serif; border:1px solid #537286; box-shadow: 0 0 5px #537286; padding:10px 15px;">
    <tbody><tr>
            <td valign="top" style=" background-color: #4b2e6b;">
                <table width="100%">
                    <tbody><tr>
                            <td>
                                <a href="{{HTTP_PATH}}">
                                    {{HTML::image(LOGO_PATH1, SITE_TITLE,['style' => 'width: 200px; height: auto;'])}}
                                </a>
                            </td>
                        </tr>
                    </tbody>
        ...
        <tr>
            <td valign="top">
                <!-- Begin Footer -->
                <table width="100%" style="border-top:1px solid #ddd; background-color:#4b2e6b; color: #0B0B0B;">
                    <tbody><tr>
                            ...
                            <td align="right">
                                <a href="{{HTTP_PATH}}">{{HTML::image(LOGO_PATH1, SITE_TITLE,['style' => 'width: 200px; height: auto;'])}}</a>
                            </td>
                        </tr>
                    </tbody></table>
                <!-- End Footer -->
