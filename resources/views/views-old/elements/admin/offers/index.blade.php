                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        @if($allrecord->status == '1')
                                        <a href="{{ URL::to( 'admin/offers/deactivate/'.$allrecord->id)}}" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        @else
                                        <a href="{{ URL::to( 'admin/offers/activate/'.$allrecord->id)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        @endif
                                    </li>
                                    <li><a href="{{ URL::to( 'admin/offers/edit/'.$allrecord->id)}}" title="Edit Offer" class=""><i class="fa fa-pencil"></i>Edit Offer</a></li>
                                    <!--<li><a href="{{ URL::to( 'admin/offers/delete/'.$allrecord->id)}}" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li>-->
