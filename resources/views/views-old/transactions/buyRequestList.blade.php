...
<div class="container">
    ...
    <div class="row" id="loadLists">
        @include('elements.transactions.buyRequestList')
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="pin-box">
                ...
                <h3 id="error_message">{{__('message.Sell Balance')}}Success!</h3>
...
<script type="text/javascript">
    function selectRequest(transId, type, value) {
        if (type == 'Accept') {
            $('#pop_message').html("{{__('message.about_receive')}} {{CURR}} "+value+"");
        } else {
            $('#pop_message').html("{{__('message.Do you want to reject this request?')}}");
        }
        $('#transId').val(transId);
    ...
    function submitRequest() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo HTTP_PATH; ?>/cancel-accept-request",
