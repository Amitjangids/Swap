                                        ...
                                        <tr>
                                            <td style="padding:25px 20px">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="color:#333333;font-family:'Nunito',sans-serif;font-size:22px;font-weight:bold;line-height:32px;text-align:left;padding-bottom:15px">Hi {{ucfirst($receiverName)}},</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            We are pleased to inform you that {{$currency}}{{$receiverAmount}} has been successfully received in your Swap wallet. The details of the transaction are as follows:</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color:#333333;font-family:'Roboto',Arial,sans-serif;font-size:16px;font-weight:normal;line-height:22px;text-align:left;padding-bottom:25px">
                                                               <table width="100%" height="100%" align="center" cellspacing="0" cellpadding="10" border="1" style="border-color: #eeeeee1a; background: rgb(226 226 226 / 16%);">
                                                                   ...
                                                                   <tr>
                                                                       <th>Amount:</th>
                                                                       <td>{{$currency}}{{ucfirst($receiverAmount)}}</td>
                                                                   </tr>
                                                                   <tr>
                                                                       <th>Fee:</th>
