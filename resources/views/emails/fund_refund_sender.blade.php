                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    We are writing to inform you that the refund of {{ $currency }}{{ $senderAmount }} has been successfully processed and deducted from your Swap wallet.
                                                ...
                                                <td
                                                    ...
                                                    <table width="100%" height="100%" align="center" cellspacing="0" cellpadding="10" border="1" style="border-color: #eeeeee1a; background: rgb(226 226 226 / 16%);">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $receiverName ? ucfirst($receiverName) : '' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Amount:</th>
