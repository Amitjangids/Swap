                ...
                <div class="row justify-content-center">
                    <div class="form-cards col-sm-6">
                        ...
                        <div class="form-group card-form-group">
                            ...
                            {{Form::text('phone', '', ['class'=>'required digits', 'placeholder'=>__('message.Enter recipient mobile number'), 'autocomplete'=>'OFF','minlenght'=>8])}}
                        </div>
                        <div class="form-group card-form-group">
                        ...
                        <button type="submit" class="btn-grad grad-two btn-one">{{__('message.Send Money')}}</button>
                        {{ Form::close()}}
                    </div>
                </div>
            </div>
