            ...
            <div class="col-lg-6">
                <div class="login-content-wrapper">
                    <div class="login-content-parent otp-page">
                        <h2> <a href="{{HTTP_PATH}}/login"><img src="{{PUBLIC_PATH}}/assets/front/images/back-icon.svg" alt="image"></a>{{__('message.OTP')}}</h2>
...
// Function to reset OTP with Ajax call and clear input fields
function resetOTP() {
    var phone = '{{$slug}}';
    $.ajax({
