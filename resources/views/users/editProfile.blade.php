                ...
                <div class="row justify-content-center">
                    <div class="form-cards col-sm-6">
                        ...
                        <div class="form-group card-form-group">
                            ...
                            {{Form::text('name', null, ['class'=>'form-control required', 'placeholder'=>__('message.Full Name'), 'autocomplete'=>'OFF','readonly'])}}
                        </div>
                        <div class="form-group card-form-group">
                            @if($recordInfo->user_type == 'Merchant')
                        ...
                        <div class="form-group card-form-group">
                            ...
                            {{Form::text('dob', null, ['class'=>'form-control required', 'placeholder'=>'Date Of Birth', 'autocomplete' => 'off','id'=>'dob1','readonly'])}}
                        </div>
                        <div class="form-group card-form-group">
                            <label>{{__('message.Select City')}}</label>
                            {{Form::select('city', $cityList,$recordInfo->city, ['id'=>'city','class' => 'form-control','placeholder' => __('message.Select City'),'disabled'=>'disabled'])}}
                        </div>
                        <div class="form-group card-form-group">
                            <label>{{__('message.Select Area')}}</label>
                            
                            {{Form::select('area', $areaList,$recordInfo->area, ['class' => 'form-control required','placeholder' => __('message.Select Area'),'disabled'=>'disabled'])}}
                        </div>
                        <div class="form-group card-form-group">
                            ...
                            {{Form::text('national_identity_number', $national_identity_number, ['class'=>'form-control required', 'placeholder'=>'Enter National ID Number', 'autocomplete'=>'OFF','readonly'])}}
                        </div>
                        </div>
                        <div class="form-group card-form-group">
