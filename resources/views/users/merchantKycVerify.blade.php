            ...
            <div class="col-sm-6">
                <div class="pre-register-form">
                    ...
                    <div class="form-group card-form-group">
                        ...
                        {{Form::text('registration_number', null, ['class'=>'form-control required', 'placeholder'=>__('message.Business Registration Number'), 'autocomplete'=>'OFF'])}}
                    </div>
                    
                    <div class="form-group ">
                        <label>{{__('message.National ID')}}</label>
                        <div class="fg-id">
                            {{Form::text('national_identity_number', '', ['class'=>'form-control', 'placeholder'=>__('message.Enter National ID Number'), 'autocomplete'=>'OFF'])}}
