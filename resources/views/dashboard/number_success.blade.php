...
<section class="tiles-section-wrapper customtiles custom-sucess-section">
    <div class="container">
        <h2>{{__('message.Number of Success')}}  {{Session::get('excel_path')}}</h2>
        <div class="row">
            <div class="col-lg-4">
           ...
           <table id='exampleTablePending' class="table table-dark table-striped" width="100%">  
               <thead>
                   <tr>
                    ...
                    <th>{{__('message.Approved/Rejected Date')}}</th>
...
var englishLocale = {
    ...
    monthNames: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
        ...
        var oTable = $('#exampleTablePending').DataTable({
            ...
            order: [[3, 'asc']],
            ajax: {
                url: "{{HTTP_PATH}}/successfull-transaction-list",
        ...
        /*$('#wallet_manager_id').change(function() {
            oTable.draw();
        });*/
        ...
        // Redirect to the export URL with query parameters
            var url = '{{ route("SuccessTransactionExcel") }}?search=' + searchValue + '&daterange=' + dateRange+ '&country_id=' + country_id+ '&wallet_manager_id=' + wallet_manager_id;
...
$('.export_excel').on('click',function(){
            // alert('ok');
    window.location.href='{{HTTP_PATH}}/success_transaction_excel';
});
</script>
