            ...
            <div class="col-lg-12">
                <div class="login-from-parent">
                    ...
                    <div class="input-box-parent from-group swap_fields">
                        ...
                        <input type="text" class="form-control required" name="IDNumber" placeholder="Enter ID Number" autocomplete="off">
                    </div>

                    <input type="hidden" name="country_id" id="country_id">
                    <div class="input-box-parent from-group">
                        <label>Wallet Manager:</label>
                        <input type="textarea" class="form-control" name="walletmanager" placeholder="Enter Wallet Manager" autocomplete="off">
                    </div>

                    <div class="input-box-parent from-group">
                        <label>Transaction Description:</label>
                        <input type="textarea" class="form-control" name="description" placeholder="Enter Transaction Description" autocomplete="off">
                    </div>
                    ...
                    <label>Receiver phone no:</label>
                        ...
                        <div class="input-box-parent">
                            ...
                            <!-- Hidden input field for country code -->
