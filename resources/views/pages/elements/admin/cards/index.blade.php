...
<div id="info{!! $allrecord->id !!}" style="display: none;">
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                @php
                $cardtype = ($allrecord->card_type == 0) ? "Airtime" : "Online Card";
                @endphp
                <div class="admin_pop"><span>Card Type: </span>  <label>{{ $cardtype }}</label></div>
