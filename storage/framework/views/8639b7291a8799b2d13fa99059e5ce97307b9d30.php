    ...
    <section class="content">
        <div class="box box-info">
           ...
           <!--  <div class="admin_search">
                ...
                <div class="add_new_record"><a href="<?php echo e(URL::to('admin/users/add')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add User</a>
                <a href="<?php echo e(URL::to('admin/users/importuser')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Import User Details</a></div>
            </div>    -->         
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.users.gabon_visa_stamp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/users/gabon_visa_stamp.blade.php ENDPATH**/ ?>