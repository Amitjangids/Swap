        ...
        <section id="no-more-tables" class="lstng-section">
            <div class="topn">
                <div class="manage_sec">
                    <div class="topn_left">External Transactions List</div>
                    ...
                    <div class="topn_left_btsec">
                        <div class="payment-info-parent">
                            <div class="payment_info">
                                ...
                                <span
                                    class="pay_body"><?php echo e(CURR); ?><?php echo e(number_format((($totalAmount['total_amount'] - floor($totalAmount['total_amount'])) > 0.5 ? ceil($totalAmount['total_amount']) : floor($totalAmount['total_amount'])), 0, '', ' ') ?? 0); ?></span>
                            </div>
                            <div class="payment_info">
                                <span class="pay_head">Total Earning</span>
                                <span
                                    class="pay_body"><?php echo e(CURR); ?><?php echo e(number_format((($totalAmount['total_fee'] - floor($totalAmount['total_fee'])) > 0.5 ? ceil($totalAmount['total_fee']) : floor($totalAmount['total_fee'])), 0, '', ' ') ?? 0); ?></span>
                            </div>
                        </div>
            ...
            <script>
                $('.export_excel').on('click', function () {
                    ...
                    var url = '<?php echo e(route("exportexcelexternal")); ?>?sender_phone=' + sender_phone + '&receiver=' + receiver + '&receiver_phone=' + receiver_phone + '&refrence=' + refrence + '&to=' + requestD;
                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td data-title="Sender Name">
                                    <?php echo e(isset($allrecord->senderName) ? ucfirst($allrecord->senderName) : 'N/A'); ?>
                                ...
                                <td data-title="Receiver Name">
                                    <?php echo e(isset($allrecord->transaction_receiver_name) ? ucfirst($allrecord->transaction_receiver_name).' '.$allrecord->transaction_receiver_lastname : 'N/A'); ?>
                                ...
                                <td data-title="Source Amount"><?php echo e('XAF ' . $allrecord->amount ?? 0); ?></td>
                                <td data-title="Source Amount"><?php echo e('XAF ' . $allrecord->transaction_amount ?? 0); ?></td>
                                <td data-title="Total Amount">

                                    <?php echo e('XAF ' . ($allrecord->amount + $allrecord->transaction_amount) ?? 0); ?>
...
<?php if(!$allrecords->isEmpty()): ?>
    <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div id="info<?php echo $allrecord->id; ?>" style="display: none;">
            <div class="nzwh-wrapper">
                <fieldset class="nzwh">
                    <legend class="head_pop">Transactions Details</legend>
                    <div class="drt">
                        ...
                        <div class="admin_pop"><span>Sender Phone: </span> <label>
                                <?php echo e($allrecord->phone); ?>

                            </label>
                        </div>
                        <div class="admin_pop"><span>Receiver Name : </span> <label>
                                <?php echo e(isset($allrecord->transaction_sender_name) ? ucfirst($allrecord->transaction_sender_name).' '.$allrecord->transaction_sender_lastname : 'N/A'); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/transactions/external_index.blade.php ENDPATH**/ ?>