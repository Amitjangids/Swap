            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="<?php echo e(URL::to('admin/merchants')); ?>" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                <?php echo e(Form::close()); ?>

                <?php if(in_array('add-merchants',$permissions)): ?>
                <div class="add_new_record"><a href="<?php echo e(URL::to('admin/merchants/add-merchants')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Merchant User</a></div>
                <?php endif; ?>
            </div>            
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.merchants.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/merchants/index.blade.php ENDPATH**/ ?>