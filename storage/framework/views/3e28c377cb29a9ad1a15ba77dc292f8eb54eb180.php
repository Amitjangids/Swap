        ...
        <section id="no-more-tables" class="lstng-section">
            ...
            <script>
                $('.export_excel').on('click', function () {
                    ...
                    var url = '<?php echo e(route("exportexcelbda")); ?>?beneficiary=' + beneficiary + '&iban=' + iban + '&refrence=' + refrence + '&to=' + requestD;
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ddpagingshorting">
                        <tr>
                            ...
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('Beneficiary', 'Beneficiary'));?></th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('IBAN', 'IBAN'));?></th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('reason', 'Comment (Reason)'));?></th>
                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td data-title="Beneficiary">
                                    <?php echo e(isset($allrecord->beneficiary) ? ucfirst($allrecord->beneficiary) : 'N/A'); ?>

                                </td>
                                <td data-title="IBAN">
                                    <?php echo e(isset($allrecord->iban) ? ucfirst($allrecord->iban) : 'N/A'); ?>

                                </td>
                                <td data-title="reason">
                                    <?php if(isset($allrecord->reason)): ?>
                                    <?php echo e(ucfirst($allrecord->reason)); ?><?php else: ?><?php echo e('N/A'); ?>
                                ...
                                <td data-title="Transaction ID"><?php echo e($allrecord->transactionId); ?></td>
...
<?php if(!$allrecords->isEmpty()): ?>
                ...
                <fieldset class="nzwh">
                    ...
                    <div class="drt">
                        ...
                        <div class="admin_pop"><span>IBAN: </span> <label>
                                <?php echo e($allrecord->iban); ?>

                            </label>
                        </div>
                        <div class="admin_pop"><span>Comment (Reason) : </span> <label>
                                <?php echo e(isset($allrecord->reason) ? ucfirst($allrecord->reason) : 'N/A'); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/transactions/bda_index.blade.php ENDPATH**/ ?>