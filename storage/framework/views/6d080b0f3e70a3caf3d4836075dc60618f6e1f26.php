...
<?php echo e(HTML::style('public/assets/css/intlTelInput.css?ver=1.3')); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php echo e(Form::text('phone', null, ['id' => 'phone',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/users/add.blade.php ENDPATH**/ ?>