    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/admins/roles')); ?>"><i class="fa fa-user"></i> <span>Manage
        ...
        <section class="content">
            <div class="box box-info">
                ...
                <?php echo e(Form::open(['method' => 'post', 'id' => 'adminForm', 'enctype' => 'multipart/form-data'])); ?>
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo e(Form::text('role_name', null, ['class' => 'form-control required', 'placeholder' => 'Department Name', 'autocomplete' => 'off'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/admins/addRole.blade.php ENDPATH**/ ?>