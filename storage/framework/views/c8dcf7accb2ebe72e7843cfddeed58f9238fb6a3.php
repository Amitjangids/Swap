        ...
        <section id="no-more-tables" class="lstng-section">
            <div class="topn">
                <div class="manage_sec">
                    <div class="topn_left">Onafriq Transactions List</div>
            ...
            <script>
                $('.export_excel').on('click', function () {
                    ...
                    var url = '<?php echo e(route("exportexcelonafriq")); ?>?sender=' + sender + '&sender_phone=' + sender_phone + '&receiver=' + receiver + '&receiver_phone=' + receiver_phone + '&refrence=' + refrence + '&to=' + requestD;
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ddpagingshorting">
                        <tr>
                            ...
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('firstName', 'Sender Name'));?></th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('senderPhoneNumber', 'Sender Phone'));?></th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('receiverFirstName', 'Receiver Name'));?></th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('receiverPhoneNumber', 'Receiver Phone'));?></th>
                            ...
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('type', 'Recipient Country'));?></th>
                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                        <tr>
                                            <td data-title="Sender Name">
                                                <?php echo e(isset($allrecord->senderName) ? ucfirst($allrecord->senderName . ' ' . $allrecord->senderSurname) : 'N/A'); ?>

                                            </td>
                                            <td data-title="Sender Phone">
                                                <?php echo e(isset($allrecord->senderMsisdn) ? $allrecord->senderMsisdn : 'N/A'); ?>

                                            </td>
                                            <td data-title="Receiver Name">
                                                <?php echo e(isset($allrecord->recipientName) ? ucfirst($allrecord->recipientName . ' ' . $allrecord->recipientSurname) : 'N/A'); ?>

                                            </td>
                                            <td data-title="Receiver Phone">
                                                <?php if(isset($allrecord->recipientMsisdn)): ?>
                                                <?php echo e($allrecord->recipientMsisdn); ?><?php else: ?><?php echo e('N/A'); ?>
                                            ...
                                            <td data-title="Transaction ID"><?php echo e($allrecord->transactionId ?? 0); ?></td>
                                            <td data-title="Type">
                                                <?php 
                                                    switch ($allrecord->recipientCountry) {
                                                        case 'BJ':
                                                            echo $recipientCountry = 'Benin';
                                                            break;
                                                        case 'BF':
                                                            echo $recipientCountry = 'Burkina Faso';
                                                            break;
                                                        case 'GW':
                                                            echo $recipientCountry = 'Guinea Bissau';
                                                            break;
                                                        case 'NE':
                                                            echo $recipientCountry = 'Niger';
                                                            break;
                                                        case 'SN':
                                                            echo $recipientCountry = 'Senegal';
                                                            break;
                                                        case 'ML':
                                                            echo $recipientCountry = 'Mali';
                                                            break;
                                                        case 'TG':
                                                            echo $recipientCountry = 'Togo';
                                                            break;
                                                    }
                                                ?>
                                            </td>
...
<?php if(!$allrecords->isEmpty()): ?>
            ...
            <div class="nzwh-wrapper">
                <fieldset class="nzwh">
                    ...
                    <div class="drt">
                        ...
                        <div class="admin_pop"><span>Fees: </span> <label>
                                <?php echo e(CURR); ?> <?php echo e(number_format((($allrecord->transaction_amount - floor($allrecord->transaction_amount)) > 0.5 ? ceil($allrecord->transaction_amount) : floor($allrecord->transaction_amount)), 0, '', ' ') ?? 0); ?>

                            </label>
                        </div>
                        <div class="admin_pop"><span>Transaction Type: </span> <label>
                                <?php echo e($allrecord->transactionType ?? 0); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/transactions/onafriq_index.blade.php ENDPATH**/ ?>