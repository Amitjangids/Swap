            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('department', 'Department'));?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="User Name"><?php echo e($allrecord->username); ?></td>
                        <td data-title="Email Address"><?php echo e($allrecord->email?$allrecord->email:'N/A'); ?></td>
                        <td><?php echo e(optional($departments->firstWhere('id', $allrecord->role_id))->role_name); ?></td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status<?php echo e($allrecord->id); ?>">
                                        ...
                                        <?php if($allrecord->status == '1'): ?>
                                        <a href="<?php echo e(URL::to( 'admin/subadmins/deactivate/'.$allrecord->slug)); ?>" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        <?php else: ?>
                                        <a href="<?php echo e(URL::to( 'admin/subadmins/activate/'.$allrecord->slug)); ?>" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        <?php endif; ?>
                                    </li>
                                    <?php
                                    ...
                                    <?php if(in_array('edit-subadmins',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/subadmins/edit-subadmins/'.$allrecord->slug)); ?>" title="Edit" class=""><i class="fa fa-pencil"></i>Edit Sub Admin</a></li>
                                    <?php endif; ?>
                                    <?php if(in_array('delete-subadmins',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/subadmins/delete-subadmins/'.$allrecord->slug)); ?>" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li>
                                    <?php endif; ?>
                                    
                                    <li><a href="#info<?php echo $allrecord->id; ?>" title="View Sub Admin Detail" class="" rel='facebox'><i class="fa fa-eye"></i>View Sub Admin Detail</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
...
<div id="info<?php echo $allrecord->id; ?>" style="display: none;">
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            <legend class="head_pop">Sub Admin Details</legend>
            <div class="drt">
                <div class="admin_pop"><span>User Name: </span>  <label><?php echo $allrecord->username; ?></label></div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/subadmins/index.blade.php ENDPATH**/ ?>