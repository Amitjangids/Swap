        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <span class="hint"><label>Search by sender name</label><?php echo e(Form::text('sender', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by sender name', 'autocomplete' =>
                        'off'])); ?></span>
                    <span class="hint"><label>Search by sender phone</label><?php echo e(Form::text('sender_phone', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by sender phone', 'autocomplete' =>
                        'off'])); ?></span>
                    <span class="hint"><label>Search by receiver name</label><?php echo e(Form::text('receiver', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by receiver name', 'autocomplete' =>
                        'off'])); ?></span>

                    <span class="hint"><label>Search by receiver phone</label><?php echo e(Form::text('receiver_phone', null,
                        ['class'=>'form-control', 'placeholder'=>'Search by receiver phone', 'autocomplete' =>
                        'off'])); ?></span>
              ...
              {{Form::select('type', $typeList,null, ['class' => 'form-control','placeholder' => 'Select transaction type'])}}
                    ...
                    <div class="admin_asearch row-button">
                        ...
                        <div class="ad_cancel"><a href="<?php echo e(URL::to('admin/onafriq-transactions')); ?>"
            ...
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.transactions.onafriq_index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/transactions/onafriq_index.blade.php ENDPATH**/ ?>