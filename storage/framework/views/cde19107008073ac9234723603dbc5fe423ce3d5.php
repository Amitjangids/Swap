    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3><?php echo e($dadhboardData['agents_count']); ?></h3>
                        <p>Agent Users</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-user-secret"></i>
                    </div>
                    <a href="<?php echo e(URL::to( 'admin/agents')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3><?php echo e($dadhboardData['merchants_count']); ?></h3>
                        <p>Merchant Users</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-users"></i>
                    </div>
                    <a href="<?php echo e(URL::to( 'admin/merchants')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3><?php echo e($dadhboardData['subadmins_count']); ?></h3>
                        <p>Sub Admin Users</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-users"></i>
                    </div>
                    <a href="<?php echo e(URL::to( 'admin/subadmins')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3><?php echo e($dadhboardData['transactions_count']); ?></h3>
                        <p>Transactions</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-money"></i>
                    </div>
                    <a href="<?php echo e(URL::to( 'admin/transactions')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                    <div class="inner">
                    <h3><?php echo e(CURR); ?><?php echo e(number_format((($adminInfo->wallet_balance - floor($adminInfo->wallet_balance)) > 0.5 ? ceil($adminInfo->wallet_balance) : floor($adminInfo->wallet_balance)), 0, '', ' ') ?? 0); ?></h3>
            ...
            <div class="col-lg-12 col-xs-12">
                <h4 class="admin_st">Agents Statistics</h2>
                    <div class="relative_box_esjad">
                        ...
                        <div class="chart_loader" id="agent_chart_loader"><?php echo e(HTML::image("public/img/website_load.svg", SITE_TITLE)); ?></div>
            ...
            <div class="col-lg-12 col-xs-12">
                <h4 class="admin_st">Merchants Statistics</h2>
                    <div class="relative_box_esjad">
                        ...
                        <div class="chart_loader" id="merchant_chart_loader"><?php echo e(HTML::image("public/img/website_load.svg", SITE_TITLE)); ?></div>
            ...
            <div class="col-lg-12 col-xs-12">
                <h4 class="admin_st">Transactions Statistics</h2>
                    <div class="relative_box_esjad">
                        ...
                        <div class="chart_loader" id="trans_chart_loader"><?php echo e(HTML::image("public/img/website_load.svg", SITE_TITLE)); ?></div>
...
<script>
    ...
    function updateAgent(daycnt) {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo e(HTTP_PATH); ?>/admin/admins/agentchart/' + daycnt,
            beforeSend: function () {
    ...
    function updateMerchant(daycnt) {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo e(HTTP_PATH); ?>/admin/admins/merchantchart/' + daycnt,
            beforeSend: function () {
    ...
    function updateTransaction(daycnt) {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo e(HTTP_PATH); ?>/admin/admins/transchart/' + daycnt,
            beforeSend: function () {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/admins/dashboard.blade.php ENDPATH**/ ?>