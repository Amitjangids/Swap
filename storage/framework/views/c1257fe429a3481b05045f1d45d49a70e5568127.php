...
<div class="panel-body marginzero">
    ...
    <section id="no-more-tables" class="lstng-section">
        <div class="topn">
            <div class="topn_left">Ecobank Location List</div>
            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('address', 'Address'));?></th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('telephone', 'Telephone'));?></th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('Latitude', 'Latitude'));?></th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('Longitude', 'Longitude'));?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Address"><?php echo e($allrecord->address ?? ""); ?></td>
                        <td data-title="Telephone"><?php echo e($allrecord->telephone ?? 'N/A'); ?></td>
                        <td data-title="Latitude"><?php echo e($allrecord->latitude ?? 'N/A'); ?></td>
                        <td data-title="Longitude"><?php echo e($allrecord->longitude ?? 'N/A'); ?></td>
                        ...
                        <td data-title="Action">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <?php if(in_array('edit-location',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/locations/edit-location/'.$allrecord->id)); ?>"
                                            title="Edit" class=""><i class="fa fa-pencil"></i>Edit Location</a></li>
                                    <?php endif; ?>

                                    <?php if(in_array('delete-location',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/locations/delete-location/'.$allrecord->id)); ?>"
                                            title="Delete" class=""
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/locations/index.blade.php ENDPATH**/ ?>