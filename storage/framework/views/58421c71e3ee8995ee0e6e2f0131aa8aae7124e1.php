...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Manage Transactions History For <?php echo e($userInfo->user_type); ?><small>(<?php echo e($userInfo->name); ?>)</small></h1>
        <ol class="breadcrumb">
...
<!--<span class="hint"><?php echo e(Form::text('for', null, ['class'=>'form-control', 'placeholder'=>'Search by transaction for', 'autocomplete' => 'off'])); ?></span>-->
                    ...
                    <div class="admin_asearch row-button">
                        ...
                        <div class="ad_cancel"><a href="<?php echo e(URL::to('admin/transactions/transactionHistory/'.$userInfo->slug)); ?>" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
            ...
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.transactions.transactionHistory', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/transactions/transactionHistory.blade.php ENDPATH**/ ?>