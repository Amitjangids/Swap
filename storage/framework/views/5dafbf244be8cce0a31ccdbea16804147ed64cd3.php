...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(URL::to('admin/users')); ?>"><i class="fa fa-cogs"></i> <span>Merchant Management</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <?php if($recordInfo->user_type == 'Merchant'): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/merchants/payclient.blade.php ENDPATH**/ ?>