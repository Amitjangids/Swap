    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/users')); ?>"><i class="fa fa-cogs"></i> <span>User Management</span></a></li>
                <li class="active"> Pay Rebate</li>
            </ol>
        </section>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="padding-top: 7px;margin-bottom: 0;">
                                <?php if($recordInfo->user_type == 'User'): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo e($recordInfo->wallet_balance); ?>
            ...
            $(document).ready(function () {
                $("#adminForm").validate({
                    ...
                    submitHandler: function (form) {
                        $('#check_form').prop('disabled', true).text('Processing...');
                        form.submit();
                    }
                });
            });
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/users/payclientrebate.blade.php ENDPATH**/ ?>