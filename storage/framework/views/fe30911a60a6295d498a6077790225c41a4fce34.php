                    ...
                    <div class="login-content-wrapper">
                        ...
                        <div class="login-from-parent">
                            ...
                            <div class="login-btn">
                                ...
                                <a href="<?php echo e(route('driver.logout')); ?>" class="btn btn-defaultx">Logout</a>
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            $("#loginform").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/driver-dashboard')); ?>",
                        type: "POST",
                            ...
                            if (response.status === 'success') {
                                ...
                                // document.getElementById('otpStatusMessage').textContent = 'OTP sent successfully';
                                    ...
                                    /* const pollingInterval = setInterval(function () {
                                        $.ajax({
                                            url: "<?php echo e(url('/verify-card-status')); ?>",
                                type: "POST",
                                    data: {
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/dashboard/driver-dashboard.blade.php ENDPATH**/ ?>