...
<div class="login-logo"><?php echo e(HTML::image(LOGO_PATH, SITE_TITLE,['style' => 'width: 200px; height: auto;'])); ?></div>
<div class="login-box-body">
    ...
    <?php echo e(Form::open(array('method' => 'POST', 'url' => 'admin/login', 'id' => 'adminlogin', 'class' => 'form form-signin'))); ?>
...
<?php echo $__env->make('layouts.adminlogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/admins/login.blade.php ENDPATH**/ ?>