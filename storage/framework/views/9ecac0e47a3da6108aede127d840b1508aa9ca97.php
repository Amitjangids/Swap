<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#adminForm").validate({
                ...
                messages: {
                    name: {
                        lettersonly: "Name should contain only alphanumeric."
                    },
                    address: {
                        lettersonly: "Address should contain only alphanumeric."
                    },
                    telephone: {
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Add Ecobank Location</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(URL::to('admin/admins/dashboard')); ?>"><i class="fa fa-dashboard"></i>
                        <span>Dashboard</span></a></li>
                <li><a href="<?php echo e(URL::to('admin/locations')); ?>"><i class="fa fa-user-secret"></i> <span>Manage Ecobank
                            Location</span></a>
                </li>
                <li class="active"> Add Ecobank Location</li>
            </ol>
        </section>
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo e(Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter Name', 'autocomplete' => 'off'])); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo e(Form::text('address', null, ['class' => 'form-control', 'placeholder' => 'Enter address', 'autocomplete' => 'off'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/locations/add.blade.php ENDPATH**/ ?>