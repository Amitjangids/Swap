    ...
    <section id="no-more-tables" class="lstng-section">
        ...
        <div class="tbl-resp-listing">
            ...
            <div class="search_frm">
                ...
                <a href="<?php echo e(URL::to( 'admin/merchants/approvekyc/'.$userInfo->slug)); ?>" title="Approve KYC" class="btn btn-info">Approve KYC</a>
                <a href="<?php echo e(URL::to( 'admin/merchants/declinekyc/'.$userInfo->slug)); ?>" title="Decline KYC" class="btn btn-info">Decline KYC</a>
                <?php elseif($userInfo->is_kyc_done == 2): ?>
                ...
                <?php if ($userInfo->kyc_status == "pending") { ?>
                    <a href="<?php echo e(URL::to('admin/merchants/approvekyc/' . $userInfo->slug)); ?>" title="Approve"
...
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/merchants/kycdetail.blade.php ENDPATH**/ ?>