            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('company_code', 'Company Name'));?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Contact Number"><?php echo e($allrecord->Company->company_name ?? ''); ?></td>
                        <td data-title="Contact Number"><?php echo e($allrecord->company_code); ?></td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status<?php echo e($allrecord->id); ?>">
                                        ...
                                        <?php if($allrecord->is_verify == '1'): ?>
                                        <a href="<?php echo e(URL::to( 'admin/agents/deactivate/'.$allrecord->slug)); ?>" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        <?php else: ?>
                                        <a href="<?php echo e(URL::to( 'admin/agents/activate/'.$allrecord->slug)); ?>" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        <?php endif; ?>
                                    </li>
                                    <?php
                                    ...
                                    <?php if(in_array('edit-agents',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/agents/edit-agents/'.$allrecord->slug)); ?>" title="Edit" class=""><i class="fa fa-pencil"></i>Edit Agent</a></li>
                                    <?php endif; ?>
                                    <?php if(in_array('payclient',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/agents/payclient/'.$allrecord->slug)); ?>" title="Pay Agent" class=""><i class="fa fa-money"></i>Pay Agent</a></li>
                                    <?php endif; ?>

                                    <?php if(in_array('remove-agent',$permissions)): ?>   
                                    <li><a href="<?php echo e(URL::to( 'admin/agents/remove-agent/'.$allrecord->slug)); ?>" title="Remove Agents" class=""><i class="fa fa-ban"></i>Remove Agent</a></li>
                                    <?php endif; ?>
                                    
                                    <!-- <li><a href="<?php echo e(URL::to( 'admin/agents/delete/'.$allrecord->slug)); ?>" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li> -->
                                    <li><a href="#info<?php echo $allrecord->id; ?>" title="View Agent Detail" class="" rel='facebox'><i class="fa fa-eye"></i>View Agent Detail</a></li>
                                    <!-- <li><a href="<?php echo e(URL::to( 'admin/sub-agents/'.$allrecord->slug)); ?>" title="View KYC Details" class=""><i class="fa fa-file"></i>Sub Agent Details</a></li> -->
                                   
                                    <?php if(in_array('kycdetail',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/agents/kycdetail/'.$allrecord->slug)); ?>" title="View KYC Details" class=""><i class="fa fa-file"></i>View KYC Details</a></li>
                                    <!-- <li><a href="<?php echo e(URL::to( 'admin/offers/agentoffers/'.$allrecord->slug)); ?>" title="View Card Offers" class=""><i class="fa fa-gift"></i>View Card Offers</a></li> -->
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/agents/index.blade.php ENDPATH**/ ?>