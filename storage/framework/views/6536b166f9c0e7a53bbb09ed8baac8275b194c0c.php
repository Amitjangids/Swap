...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        }, "Password must be at least 9 characters long, contains an upper case letter, a lower case letter, a number and a symbol.");
        $("#adminForm").validate();
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(URL::to('admin/merchants')); ?>"><i class="fa fa-users"></i> <span>Manage Merchant Users</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo e(Form::text('business_name', null, ['class'=>'form-control required', 'placeholder'=>'Business Name', 'autocomplete' => 'off', 'maxlength' => 15,'oninput' => 'validateName(this)'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo e(Form::text('name', null, ['class'=>'form-control required', 'placeholder'=>'Business Owner Name', 'autocomplete' => 'off', 'maxlength' => 15,'oninput' => 'validateName(this)'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo e(Form::text('email', null, ['class'=>'form-control  email', 'placeholder'=>'Business Email', 'autocomplete' => 'off'])); ?>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(URL::to( 'admin/merchants')); ?>" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/merchants/edit.blade.php ENDPATH**/ ?>