...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(URL::to('admin/agents')); ?>"><i class="fa fa-user-secret"></i> <span>Manage Agent Users</span></a></li>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php echo e(Form::text('phone', null, ['id'=>'phone','class'=>'form-control required digits', 'placeholder'=>'Phone Number', 'autocomplete' => 'off','minlength' => '8','maxlength' => '15'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php echo e(Form::select('company_code', $company_code, null, ['class' => 'form-control required', 'placeholder' => (Session::get('admin_role') != env('AGGREGATOR_ID')) ? 'Select Company' : null])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/agents/edit.blade.php ENDPATH**/ ?>