        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    <span class="hints">Search by Name or Email Address or Phone Number</span>
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="<?php echo e(URL::to('admin/drivers')); ?>" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
            ...
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.drivers.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/drivers/index.blade.php ENDPATH**/ ?>