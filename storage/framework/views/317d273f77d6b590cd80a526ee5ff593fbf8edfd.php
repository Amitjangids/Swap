            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('api_enable', 'API Status'));?></th> -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td data-title="API Key" id="api_key_<?php echo e($allrecord->slug); ?>"><?php echo e($allrecord->api_key); ?></td>
                        <td data-title="API Status" id="apiverify_<?php echo e($allrecord->slug); ?>">
                            <?php if($allrecord->api_enable == 'Y'): ?>
                                Activated
                            <?php else: ?>
                                Deactivated
                            <?php endif; ?>
                        ...
                        <td data-title="KYC Status"><?php echo e(ucfirst($allrecord->kyc_status)); ?>
                            ...
                            <!-- <?php if($allrecord->is_kyc_done == 1): ?>
                            Approved
                            <?php elseif($allrecord->is_kyc_done == 2): ?>
                            Declined
                            <?php elseif($allrecord->is_kyc_done == 3): ?>
                            Not Submitted
                            <?php else: ?>
                            Pending
                            <?php endif; ?> -->
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status<?php echo e($allrecord->id); ?>">
                                        ...
                                        <?php if($allrecord->is_verify == '1'): ?>
                                        <a href="<?php echo e(URL::to( 'admin/merchants/deactivate/'.$allrecord->slug)); ?>" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate</a>
                                        <?php else: ?>
                                        <a href="<?php echo e(URL::to( 'admin/merchants/activate/'.$allrecord->slug)); ?>" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate</a>
                                        <?php endif; ?>
                                    </li>
                                    <?php
                                    ...
                                    <li><a href="<?php echo e(URL::to( 'admin/merchants/edit-merchants/'.$allrecord->slug)); ?>" title="Edit" class=""><i class="fa fa-pencil"></i>Edit Merchant</a></li>
                                    <?php endif; ?>
                                    <?php if(in_array('payclient',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/merchants/payclient/'.$allrecord->slug)); ?>" title="Pay Merchant" class=""><i class="fa fa-money"></i>Pay Merchant</a></li>
                                    <!-- <li><a href="<?php echo e(URL::to( 'admin/merchants/delete/'.$allrecord->slug)); ?>" title="Delete" class="" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i>Delete</a></li> -->
                                    <?php endif; ?>
                                    <li><a href="#info<?php echo $allrecord->id; ?>" title="View Merchant Detail" class="" rel='facebox'><i class="fa fa-eye"></i>View Merchant Detail</a></li>
                                    <?php if(in_array('kycdetail',$permissions)): ?>
                                    <li><a href="<?php echo e(URL::to( 'admin/merchants/kycdetail/'.$allrecord->slug)); ?>" title="View KYC Details" class=""><i class="fa fa-file"></i>View KYC Details</a></li>
                                    <?php endif; ?>
                                    ...
                                    <li><a href="<?php echo e(URL::to( 'admin/transactions/transactionHistory/'.$allrecord->slug)); ?>" title="Manage Transaction History" class=""><i class="fa fa-money"></i>Transaction History</a></li>
                                    <?php endif; ?>
                                    ...
                                    <!-- <li><a href="<?php echo e(URL::to( 'admin/merchants/merchantSetting/'.$allrecord->slug)); ?>" title="Manage Merchant Setting" class=""><i class="fa fa-cog"></i>Manage Merchant Setting</a></li> -->
                                    <!-- <li class="right_acdc" id="api_status<?php echo e($allrecord->id); ?>">
                                        <?php if($allrecord->api_enable == 'Y'): ?>
                                        <a href="<?php echo e(URL::to( 'admin/merchants/api-deactivate/'.$allrecord->slug)); ?>" title="API Key Deactivate" class="apideactivate"><i class="fa fa-check"></i>Deactivate API Key</a>
                                        <?php else: ?>
                                        <a href="<?php echo e(URL::to( 'admin/merchants/api-activate/'.$allrecord->slug)); ?>" title="API Key Activate" class="apiactivate"><i class="fa fa-ban"></i>Activate API Key</a>
                                        <?php endif; ?>
                                    </li> -->
                                </ul>
                            </div>
    ...
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                ...
                <div class="admin_pop"><span>Business Name: </span>  <label><?php echo $allrecord->business_name; ?></label></div>
                <div class="admin_pop"><span>Business Owner Name: </span>  <label><?php echo $allrecord->name; ?></label></div>
                <div class="admin_pop"><span>Wallet Balance: </span>  <label><?php echo CURR.' '.number_format((($allrecord->wallet_balance - floor($allrecord->wallet_balance)) > 0.5 ? ceil($allrecord->wallet_balance) : floor($allrecord->wallet_balance)), 0, '', ' ') ?? 0; ?></label></div>
                <div class="admin_pop"><span>Business Email: </span>  <label><?php echo e($allrecord->email?$allrecord->email:'N/A'); ?></label></div>
                ...
                <?php if($allrecord->profile_image != ''): ?>
                    <div class="admin_pop"><span>Profile Image</span> <label><?php echo e(HTML::image(PROFILE_FULL_DISPLAY_PATH.$allrecord->profile_image, SITE_TITLE,['style'=>"max-width: 200px"])); ?></label></div>

                <?php endif; ?>
                
<!--                <?php if($allrecord->identity_image != ''): ?>
                    <div class="admin_pop"><span>Picture of business owner’s national identity</span> <label><?php echo e(HTML::image(IDENTITY_FULL_DISPLAY_PATH.$allrecord->identity_image, SITE_TITLE,['style'=>"max-width: 200px"])); ?></label></div>
                <?php endif; ?>-->
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/internal-swap-africa/resources/views/elements/admin/merchants/index.blade.php ENDPATH**/ ?>