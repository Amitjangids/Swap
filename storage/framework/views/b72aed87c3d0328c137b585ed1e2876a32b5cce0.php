    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch row-button">
                        ...
                        <div class="ad_cancel"><a href="<?php echo e(URL::to('admin/airtel-transaction')); ?>" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
            ...
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.transactions.airtel_index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/transactions/airtel_index.blade.php ENDPATH**/ ?>