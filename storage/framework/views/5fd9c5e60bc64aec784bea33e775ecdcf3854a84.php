...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(URL::to('admin/subadmins')); ?>"><i class="fa fa-user-secret"></i> <span>Manage Sub Admins</span></a></li>
        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         <?php echo e(Form::select('role_id', $roleList,null, ['class' => 'form-control required'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo e(Form::text('username', null, ['class'=>'form-control required alphanumeric', 'placeholder'=>'Username', 'autocomplete' => 'off'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo e(Form::text('email', null, ['class'=>'form-control email', 'placeholder'=>'Email Address', 'autocomplete' => 'off'])); ?>
                                    ...
                                    <div class="sizemorescroll">
                                        <div class="cloth_size"> 
                                            ...
                                            foreach($roles as $roleKey => $roleVal){ ?>
                                                ...
                                                <div class="main_role"><input class='' type="checkbox" id="StrategyAsset<?php echo e($roleKey); ?>" value="<?php echo e($roleKey); ?>" name="role_ids[]" onclick="checkSubRole(<?php echo e($roleKey); ?>)"><label><?php echo e($roleVal); ?></label></div>
    ...
    <?php echo e(HTML::script('public/assets/js/intlTelInput.js')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/internal-swap-africa/resources/views/admin/subadmins/add.blade.php ENDPATH**/ ?>